...
2.  Is there an apparent trend in the number of girls baptized over the years?  
    ...
    **The apparent trend is number of girls baptized over the years keeps increasing generally.**
...
-   How do these counts compare to Arbuthnot's? Are they on a similar scale?
    `Yes they are on a similar scale ie they are measured on a yearly basis`
    ```{r}
    summary(arbuthnot)
    summary(present)
    ```
    `The number of boys and girls in the present data set is way larger than arbuthnot as shown by summary function`
...
-   Make a plot that displays the boy-to-girl ratio for every year in the data 
    ...
    ```
    **Arbuthnot's observaton about boys being born in greater proportion than girls hold up in the U.S but the genral treand is going in favor of girls.**
